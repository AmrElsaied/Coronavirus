...
public class GameController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (flag == 1)
        {
            ...
            //if (Innova.transform.position.z < 18)
            //{
            ...
            if (Innova.transform.position.y > 1)
            {
               ...
               // }
                ...
                else { if (Innova.transform.eulerAngles.y <270) { Innova.transform.Rotate(turn * Time.deltaTime * 2f); } else { animate.AnimateWelcome(); reticlePointer.SetActive(false); Innova.GetComponent<PlayerAnimmatorController>().starts = 1; flag = 2; } }
